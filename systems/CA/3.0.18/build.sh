...
mvn dependency:get -fn -DgroupId=org.apache.ant -DartifactId=ant-junit -Dversion=1.9.4 -Dpackaging=jar
mvn dependency:get -fn -DgroupId=org.apache.hadoop -DartifactId=hadoop-core -Dversion=1.0.3 -Dpackaging=jar
...
mvn dependency:get -fn -DgroupId=org.apache.rat -DartifactId=apache-rat -Dversion=0.10 -Dpackaging=jar
mvn dependency:get -fn -DgroupId=com.google.code.findbugs -DartifactId=jsr305 -Dversion=2.0.2 -Dpackaging=jar
mvn dependency:get -fn -DgroupId=org.caffinitas.ohc -DartifactId=ohc-core -Dversion=0.4.3 -Dpackaging=jar
mvn dependency:get -fn -DgroupId=org.openjdk.jmh -DartifactId=jmh-core -Dversion=1.1.1 -Dpackaging=jar
mvn dependency:get -fn -DgroupId=org.caffinitas.ohc -DartifactId=ohc-core-j8 -Dversion=0.4.3 -Dpackaging=jar
mvn dependency:get -fn -DgroupId=org.antlr -DartifactId=antlr -Dversion=3.5.2 -Dpackaging=jar
mvn dependency:get -fn -DgroupId=org.apache.hadoop -DartifactId=hadoop-minicluster -Dversion=1.0.3 -Dpackaging=jar
mvn dependency:get -fn -DgroupId=org.openjdk.jmh -DartifactId=jmh-generator-annprocess -Dversion=1.1.1 -Dpackaging=jar
mvn dependency:get -fn -DgroupId=org.jacoco -DartifactId=org.jacoco.agent -Dversion=0.7.5.201505241946 -Dpackaging=jar
mvn dependency:get -fn -DgroupId=org.jboss.byteman -DartifactId=byteman-install -Dversion=3.0.3 -Dpackaging=jar
...
(cd $SYS_VER && ant -Drat.skip=true -keep-going)
