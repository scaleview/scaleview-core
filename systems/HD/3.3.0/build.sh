...
CATALOG_WEBAPP_PATH=hadoop-yarn-project/hadoop-yarn/hadoop-yarn-applications/hadoop-yarn-applications-catalog/hadoop-yarn-applications-catalog-webapp

sed -i "s|<nodeVersion>v8.11.3</nodeVersion>|<nodeVersion>v16.13.0</nodeVersion>|g" $SYS_VER/$CATALOG_WEBAPP_PATH/pom.xml
sed -i "s|<yarnVersion>v1.7.0</yarnVersion>|<yarnVersion>v1.22.19</yarnVersion>|g" $SYS_VER/$CATALOG_WEBAPP_PATH/pom.xml
